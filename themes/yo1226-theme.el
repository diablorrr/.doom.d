...
(custom-theme-set-faces
 ...
 '(fixed-pitch ((t (:family "简" :foundry "????" :width normal :height 145 :weight regular :slant normal))))
 '(variable-pitch ((t (:family "简" :foundry "????" :width normal :height 157 :weight regular :slant normal))))
