...
(custom-theme-set-faces
 'myTheme
 '(default ((t (:family "Source Code Pro" :foundry "ADBO" :width normal :height 102 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#2E3436" :background "#EDEDED" :stipple nil :inherit nil))))
 '(cursor ((t (:background "#00BBFF"))))
 '(fixed-pitch ((t (:family "Source Code Pro" :foundry "ADBO" :width normal :height 102 :weight regular :slant normal))))
 '(variable-pitch ((t (:family "Noto Sans" :foundry "GOOG" :width normal :height 102 :weight regular :slant normal))))
 '(escape-glyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
 '(homoglyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
 '(minibuffer-prompt ((t (:weight bold :foreground "#0084C8"))))
 '(highlight ((t (:foreground "white" :background "hot pink"))))
