(deftheme yoshikiDark
  "Created 2024-12-27.")

(custom-theme-set-faces
 'yoshikiDark
 '(default ((t (:family "更纱终端书呆黑体-简" :foundry "????" :width normal :height 145 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#bbc2cf" :background "#282c34" :stipple nil :inherit nil))))
